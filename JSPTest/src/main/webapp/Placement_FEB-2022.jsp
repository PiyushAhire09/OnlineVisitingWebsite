...
<body>
<h2 class="h2">Placement Status of Students for FEB 2022</h2>
...
<sql:query dataSource="${ds}" var="rsPlaced"> 
    ...
    FROM companyDetail
    WHERE admissionYear = 'FEB 2022' AND placementStatus = 'Placed'; 
</sql:query>

<sql:query dataSource="${ds}" var="rsUnplaced"> 
    SELECT COUNT(*) AS unplacedCount
    FROM companyDetail
    WHERE admissionYear = 'FEB 2022' AND placementStatus = 'Unplaced'; 
</sql:query>
...
<sql:query dataSource="${ds}" var="rsDetails"> 
    ...
    WHERE CD.admissionYear = 'FEB 2022'; 
</sql:query>
...
<script>
    ...
    new Chart("myChart", {
        ...
        options: {
            ...
            title: {
                display: true,
                text: "Placement Status of Students for FEB 2022"
            }
        }
    });
</script>
